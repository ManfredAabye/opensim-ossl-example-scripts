/*
This script listens for commands on channel 5 and performs various actions such as banning or allowing avatars on the land, 
based on the received commands. 
Each section of the code is commented for better understanding.
*/
...
default
{
    ...
    listen(integer chan, string name, key id, string message)
    {
        ...
        if (command != "")
        {
            // Notify the owner that the previous command is still being processed
        ...
        else if (command == "clearpass") // Use "else if" to avoid unnecessary checks
        {
