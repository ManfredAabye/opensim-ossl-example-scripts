/*
This script sets up two sounds to be played in OpenSim. 
When an object containing this script is touched, it toggles between playing and stopping the sounds defined as sound_master and sound_slave. 
The sounds are preloaded to reduce lag when they start playing. The volume of the sounds is set to 1.0, 
which represents full volume. Additionally, it sends a message to the public channel indicating how to use the script when the object enters the default state.
*/
